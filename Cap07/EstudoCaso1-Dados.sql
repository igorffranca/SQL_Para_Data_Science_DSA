...
# Carrega os dados
LOAD DATA LOCAL INFILE 'C:/Users/igorf/Documents/MEGA/Faculdade/Cursos/Formacao_Analista_de_dados/SQL_para_Data_Science/Capitulo_7/3-Scripts-Cap07/EstudoCaso1/covid_mortes.csv' INTO TABLE `cap07`.`covid_mortes` CHARACTER SET UTF8
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'C:/Users/igorf/Documents/MEGA/Faculdade/Cursos/Formacao_Analista_de_dados/SQL_para_Data_Science/Capitulo_7/3-Scripts-Cap07/EstudoCaso1/covid_vacinacao.csv' INTO TABLE `cap07`.`covid_vacinacao` CHARACTER SET UTF8
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
